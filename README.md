...
cd /tmp/ && yum install git -y && git clone https://github.com/ngovanquang12c3/Unlimited-OpenVPN-2.13.1 && cd Unlimited-OpenVPN-2.13.1/ && sed -i -e 's/\r$//' openvpn_2_13_1.sh && chmod 755 openvpn_2_13_1.sh && ./openvpn_2_13_1.sh
